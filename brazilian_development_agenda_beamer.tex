...
\begin{frame}{1999 changed the stabilization mechanism}
  \begin{center}\includegraphics[width=.90\textwidth,height=.43\textheight,keepaspectratio]{fig_brl_usd.pdf}\end{center}
  \begin{columns}[T,onlytextwidth]
    \column{.48\textwidth}
...
\begin{frame}{Stability did not restore sustained growth}
