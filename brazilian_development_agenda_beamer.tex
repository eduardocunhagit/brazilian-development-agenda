...
% Hook: Pix
\begin{frame}{You have probably already used today's puzzle}
  \begin{columns}[T,onlytextwidth]
    ...
    \column{.52\textwidth}
      \begin{itemize}
        \item If you bought a coffee in Rio this month, you probably saw Pix: free, instant payments built by the central bank in 2020.
        \item The same country still struggles to deliver sewage connections, basic mathematics learning, and safe streets.
      \end{itemize}
      \vspace{.25cm}
      \begin{beamercolorbox}[rounded=true,sep=.6em,wd=\textwidth]{exampleblock body}
        \key{Today's theme in one contrast:} Brazil builds frontier institutions --- and struggles to spread their benefits.
      \end{beamercolorbox}
  \end{columns}
...
\begin{frame}{The lecture starts from one puzzle}
  \vspace{0.5cm}
  \question{Why has a large, urban, resource-rich economy with strong institutions in selected areas failed to achieve sustained income convergence --- that is, to keep catching up with rich-country income per person?}
  \vspace{0.6cm}
  \begin{columns}[T,onlytextwidth]
    \column{.31\textwidth}
  ...
  \end{columns}
  \vspace{.3cm}
  \muted{\small We return to this question at the end of every block --- and answer it in the final slide.}
\end{frame}
...
\begin{frame}{Roadmap for 150 minutes}
  \begin{tabularx}{\textwidth}{>{\bfseries}p{2.2cm}X}
    \toprule
    0--20 min & \textbf{Orientation} --- the puzzle, the map, the timeline \\
    20--65 min & \textbf{Part I: Making growth possible} --- inflation, the 1999 regime change, fiscal policy, investment \\
    65--75 min & Break \\
    75--125 min & \textbf{Part II: Making growth happen} --- firms, workers, infrastructure, and a security case study \\
    125--140 min & \textbf{Part III: The integrated agenda} --- constraints, political economy, and the R\$100 exercise \\
    140--150 min & \textbf{Questions and discussion} \\
    \bottomrule
  \end{tabularx}
  \vspace{.3cm}

  \muted{\small Backup slides with formulas, full tables, and measurement details are in the appendix.}
\end{frame}

% =============================================================================
% Part I - Making growth possible
% =============================================================================
\sectionframe{Part I -- Making growth possible}{Macroeconomic stability, the 1999 regime change, fiscal space, and investment}
...
\begin{frame}{Macro synthesis: three messages}
  ...
  \end{enumerate}
  \vspace{.4cm}
  \question{So why did stable prices not bring convergence? That is Part II.}
...
\begin{frame}{Inclusion has a color and an address}
  \begin{columns}[T,onlytextwidth]
    \column{.31\textwidth}
      \begin{block}{Income and work}
        White workers earn about 70\% more on average; Black and brown workers are overrepresented in informal jobs.
      \end{block}
    \column{.31\textwidth}
      \begin{block}{Services and territory}
        Sanitation, transport, and school gaps concentrate in majority-Black peripheries and the North and Northeast.
      \end{block}
    \column{.31\textwidth}
      \begin{block}{Violence}
        Roughly four in five homicide victims in Brazil are Black.
      \end{block}
  \end{columns}
  \vspace{.2cm}
  \begin{itemize}
    \item Black and brown Brazilians are 55.5\% of the population --- majority conditions, not edge cases. Poverty fell through labor income and transfers, but race and territory still predict who is poor.
  \end{itemize}
  \question{Race and territory are not separate topics: they are where the aggregate gaps live.}
  \source{IBGE, 2022 Census and Desigualdades Sociais por Cor ou Raça no Brasil; Ipea/FBSP, Atlas da Violência 2026; Ipea, Poverty and Inequality 1995--2024.}
\end{frame}
...
% =============================================================================
% Part III - Constraints and the integrated agenda
% =============================================================================
\sectionframe{Part III -- The integrated agenda}{Demography, climate, political economy, and what to do first}
...
\begin{frame}{Why are apparently beneficial reforms difficult to implement?}
  \begin{columns}[T,onlytextwidth]
    \column{.48\textwidth}
...
\begin{frame}{Priority exercise: allocate a reform budget}
  ...
  \vspace{.45cm}
  \begin{itemize}
    \item Name one complement without which your largest allocation would fail, and one group or region that bears the transition cost.
    \item \muted{8 minutes in groups, then 5 minutes of report-backs.}
  \end{itemize}
\end{frame}

\begin{frame}{Answering the opening puzzle}
  \question{Why has Brazil failed to achieve sustained income convergence?}
  \vspace{.25cm}
  \begin{beamercolorbox}[rounded=true,sep=.7em,wd=\textwidth]{exampleblock body}
    \textbf{Brazil has repeatedly demonstrated the capacity to solve difficult problems. Its central development challenge is not the absence of successful institutions, but the failure to diffuse capabilities across firms, workers, cities, and regions.}
  \end{beamercolorbox}
  \vspace{.25cm}
  \begin{enumerate}
    \item \key{Stability made growth possible} --- the Real Plan and the post-1999 architecture ended the crises that destroyed planning.
    \item \key{Diffusion makes growth happen} --- Embrapa, Pix, and frontier firms prove capability; taxes, credit, learning, and infrastructure keep it from spreading.
    \item \key{State capacity and coalitions set the pace} --- reforms succeed when implementation and compensation are designed in.
  \end{enumerate}
  \vspace{.25cm}
  \centering\large\textbf{Questions and discussion --- 10 minutes}
\end{frame}
