...
An open, 150-minute lecture on Brazil's economic development agenda, prepared for international students. The 70-slide deck is written in English and built with LaTeX Beamer.
...
- An integrated macro-micro reform agenda
...
The script downloads public series from the Banco Central do Brasil's SGS API. The committed CSV files are a reproducible snapshot retrieved on July 20, 2026. Other figures use the public sources listed in [`brazilian_development_agenda_assets/SOURCES.md`](brazilian_development_agenda_assets/SOURCES.md).
